    ...
    try {
        ...
        foreach ($data as $row) {
            ...
            if(isset($row['cnaeuf'])){
                $flagcnae = true;
                $cnae = $row['cnaeuf']; 
            } else if(isset($row['cnaeregiao'])){
                $flagcnae = true;
                $flagregiao = true;
                $cnae = $row['cnaeregiao'];
            } else if(isset($row['cbouf'])){
                $cnae = $row['cbouf'];
            } else if(isset($row['cboregiao'])){
                $flagregiao = true;  
                $cnae = $row['cboregiao'];
            }
        ...
        if ($flagcnae == false && $flagregiao == false) {
            $query = "INSERT INTO PI_fornecedores_ocupacoes_UF (id, ocupacao, media_salarial, `18-29`, `30-39`, `40-49`, `50-59`, `60+`, media_idade, uf, date) VALUES $placeholders";
        } else if($flagcnae == false && $flagregiao == true){
            $query = "INSERT INTO PI_fornecedores_ocupacoes_regiao (id, ocupacao, media_salarial, `18-29`, `30-39`, `40-49`, `50-59`, `60+`, media_idade, regiao, date) VALUES $placeholders";
        } else if($flagcnae == true && $flagregiao == false){
            $query = "INSERT INTO PI_fornecedores_cnaes_UF (id, cnae, media_salarial, `18-29`, `30-39`, `40-49`, `50-59`, `60+`, media_idade, uf, date) VALUES $placeholders";
        } else if($flagcnae == true && $flagregiao == true){
            $query = "INSERT INTO PI_fornecedores_cnaes_regiao (id, cnae, media_salarial, `18-29`, `30-39`, `40-49`, `50-59`, `60+`, media_idade, regiao, date) VALUES $placeholders";
        }
